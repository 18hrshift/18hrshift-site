export const site = {
  ...
  archive: [
    { id: '01', label: 'REDACTED',    type: 'VIDEO',       year: '2025' },
    { id: '02', label: 'CLASSIFIED',  type: 'INTERACTIVE', year: '2025' },
    { id: '03', label: 'UNDISCLOSED', type: 'SERIES',      year: '2024' },
    { id: '04', label: '████████',    type: 'CAMPAIGN',    year: '2024' },
    { id: '05', label: 'PENDING',     type: 'LIVE',        year: '2026' },
    { id: '06', label: 'UNKNOWN',     type: 'GAME',        year: '2026' },
  ],
